...
var AjaxAgentCategories = function () {
	function AjaxAgentCategories(client) {
		_classCallCheck(this, AjaxAgentCategories);

		this.client = client;
		this.resourceUrl = '/agent_categories';
	}

	_createClass(AjaxAgentCategories, [{
		key: 'list',
	...
	return AjaxAgentCategories;
}();

exports.default = AjaxAgentCategories;