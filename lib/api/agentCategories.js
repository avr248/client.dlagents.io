...
var AgentCategories = function () {
	function AgentCategories(client) {
		_classCallCheck(this, AgentCategories);

		this.client = client;
		this.resourceUrl = '/agent_categories';
	}

	_createClass(AgentCategories, [{
		key: 'list',
...
exports.default = AgentCategories;